...
function SignUpPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen" style={{ backgroundColor: '#eeeeee' }}>
      ...
      <div className="signup-form-container" style={{ maxWidth: '450px', marginTop: '-1rem' }}>
        <form id="signup-form" className="bg-white p-4 sm:p-8 rounded-lg shadow-md mx-auto" onSubmit={handleSignUp}>
          <h2 className="text-3xl sm:text-4xl font-bold mb-4 sm:mb-6 text-LEFT">Sign Up</h2>
          {showErrorMessage() && <p className="text-red-600 mb-2 sm:mb-4">{showErrorMessage()}</p>}
          <div className="mb-2 sm:mb-4">
            <label className="block text-gray-700 text-sm font-bold mb-1 sm:mb-2" htmlFor="email">Email</label>
            <input 
          ...
          <div className="mb-1 sm:mb-2">
            <label className="block text-gray-700 text-sm font-bold mb-1 sm:mb-2" htmlFor="password">Password</label>
            <input 
          ...
          <div className="mb-1 sm:mb-2">
            <label className="block text-gray-700 text-sm font-bold mb-1 sm:mb-2" htmlFor="confirmPassword">Confirm Password</label>
            <input 
              className="rounded-lg shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 mb-1 sm:mb-3 leading-tight focus:outline-none focus:shadow-outline bg-custom-input" 
              id="confirmPassword" 
              type="password" 
